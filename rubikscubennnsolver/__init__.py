...
class RubiksCube(object):
    ...
    def mysolve11(self, solution333: str = None) -> None:
        """
        The RubiksCube222 and RubiksCube333 child classes will override this since they do not
        need to group centers or edges
    ...
    def mysolve5(self, solution333: str = None) -> None:
        if self.solved():
            return
    ...
    def mysolve6(self, solution333: str = None) -> None:
        if self.solved():
            return
    ...
    def mysolve7(self, solution333: str = None) -> None:
        if self.solved():
            return
    ...
    def mysolve9(self, solution333: str = None) -> None:
        if self.solved():
            return
    ...
    def mysolve10(self, solution333: str = None) -> None:
        if self.solved():
            return
